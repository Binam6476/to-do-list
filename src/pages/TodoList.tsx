      ...
      <div className="gap-2 rounded-3xl border-2 border-slate-300 bg-gray-300 p-4 md:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <div className="flex flex-col gap-2 ">
             <div className="flex flex-col gap-2">
                <a href="/createTodo" className="bg-blue-600 rounded-3xl px-2.5 text-center hover:cursor-pointer hover:bg-blue-800 p-2 text-white">create new todo</a>
            </div>
            {todos.length>0&&(
               <button onClick={()=>clearTodos()} className="bg-red-600 px-2.5 p-2 rounded-3xl hover:cursor-pointer hover:bg-red-800 text-white ">Clear todo</button>
          ...
          <div className="grid grid-cols-3 gap-3 ">
            {todos.map((todo) => (
              <div
                key={todo.id}
                className="bg-gray-300 rounded-2xl shadow-inherit p-4  hover:bg-gray-400">
                <div className=" flex gap-2 justify-end">
                  <button 
                  onClick={()=>navigate(`/edit/${todo.id}`)}
                  className="bg-green-500 px-2 rounded-md hover:cursor-pointer hover:bg-green-700">
                    Edit
                  </button>
                  <button
